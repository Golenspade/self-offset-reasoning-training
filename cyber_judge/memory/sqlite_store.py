...
class MemoryStore:
    ...
    async def save_message(self, user_id: str, message: str, 
                          group_id: str = None, metadata: Dict = None):
        """保存用户消息"""
        cursor = self.conn.cursor()
    ...
    async def save_judgment(self, user_id: str, case: str, verdict: str,
                           personality: str, group_id: str = None):
        """保存判决记录"""
        cursor = self.conn.cursor()
    ...
    async def search_messages(self, query: str, user_id: str = None, 
